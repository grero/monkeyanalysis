function [num_channels,sampling_rate,scan_order,header_size]=nptReadStreamerFileHeader(rawfile)
...
if fid==-1
   ...
   myerror = 1;
	...
	[num_channels,sampling_rate,scan_order,header_size] = nptParseStreamerHeader(fid);
